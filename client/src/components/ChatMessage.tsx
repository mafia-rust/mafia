...
import { ChatGroup, Conclusion, DefensePower, RoleOutlineReference, PhaseState, PlayerIndex, Tag, translateConclusion, translateWinCondition, Verdict, WinCondition } from "../game/gameState.d";
