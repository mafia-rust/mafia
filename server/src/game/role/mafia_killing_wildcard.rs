...
use super::{wildcard::Wildcard, ControllerID, ControllerParametersMap, Role, RoleStateImpl};
...
impl RoleStateImpl for MafiaKillingWildcard {
    ...
    fn controller_parameters_map(self, game: &Game, actor_ref: PlayerReference) -> super::ControllerParametersMap {
        ControllerParametersMap::builder(game)
            ...
            .single_role_selection_role_set(game, RoleSet::MafiaKilling,&vec_set![Role::MafiaKillingWildcard])
