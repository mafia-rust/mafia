...
use crate::game::Game;
use super::{Priority, RoleState, Role, RoleFunctions};
...
impl RoleFunctions for Vigilante {
    fn suspicious() -> bool {false}
    fn witchable() -> bool {true}
    fn defense() -> u8 {0}
    fn roleblockable() -> bool {true}
    fn faction_alignment(&self) -> FactionAlignment {FactionAlignment::TownKilling}
    ...
    fn do_night_action(self, game: &mut Game, actor_ref: PlayerReference, priority: Priority) {
        ...
        match priority{
            ...
            Priority::Kill => {
                if self.bullets_remaining < 1 || self.will_suicide || game.phase_machine.day_number == 1 {return;}
